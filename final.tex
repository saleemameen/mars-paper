...
Starting with power consumption and generation - arguably, the foundation of all subsequent processes - KCSAR requires on average ~1GWe (with an upper limit of ~3GWe) to sustain life for one million people. KCSAR’s power generation model encompasses ~16GW of instantaneous power, which is generated from three different processes: (1) 10GWth power output is produced from an integral fast-spectrum two-fluid molten-salt reactor that operates at 750\degree C, (2) 3GWe power output is yielded from a series of mass-producible standard sCo2 Brayton cycle pressure turbine systems that are connected to the reactor, and (3) 3GWe power output is derived from a cryogenic battery made up of LN2 that has a 24h capacity of 36GWh. Essential to the efficacy of this power generation model, is the requirement for an effective heat-sink, driven largely by the heat density of the molten salt reactor design and the difficulty of thermal rejection on Mars, due to the absence of a thick atmosphere and large bodies of water. Given that KCSAR is strategically located on water ice, it is well positioned to provide the required heat sink, and in fact, offers additional synergistic benefits across the entire supply chain, as will be observed shortly.

The reactor itself is an integral design made up of standard high temperature materials, and houses a single crucible that contains the entire assembly. It uses Hastalloy-N disposable fuel pins, which are filled with a fuel salt mixture that comprises plutonium and U238. These pins are the only superalloys that are required to be produced and shipped from Earth. Since it is a fast spectrum reactor, there is no requirement to isotropically separate lithium for the FliBe mixed fuel salt. The fuel salt is separated and shipped carefully because of potential condensation of fission products, such as the outgassing of Xenon and Krypton from the heat transport salt. As a liquid fuel, it can be burned more completely because the standard Xenon intercalation problems found in MOX are not present. The coolant salt is then wrapped in a Thorium salt ‘blanket’, allowing it to be bred for Pa and then U233 for use in nuclear thermal vehicles, along with Kilopower style stationary reactors for things such as mining colonies. The outer coolant salt is chloride based. By operating under Argon on Mars, the usual corrosion problems associated with water or oxygen impurities in the fuel salt is removed. As a complete system, the reactor is designed to run at 100\% capacity at  all times, redirecting its output into industrial tasks, if there is sufficient supply of electrical power.

Part of KCSAR’s engineering philosophy is the notion that maximal utility must be embodied into the design of every system. Thus, we will note how the reactor seamlessly permeates into other energy-producing processes that augment the energy capacity of KCSAR (refer to figure \ref{fig:power_diagram} for a diagrammatic representation of the power generation distribution). Excess thermal energy from the reactor is used within a  larger series of connected sCo2 Brayton cycle pressure turbines. The benefit of using these over high-pressure turbines is that they are mass-producible and do not require precision parts that are often difficult to transport. Input into the system are a combination of byproducts such as reactor fluids, absorption chillers, and waste heat from chemical industrial plants, which are then managed by a thermal distribution system that generates various output loops at chemically useful temperatures, as well as a rejection loop for any heat that is too low grade for industry. The combined heat and power system (driven largely by the reactor’s excess thermal energy), produces ‘plant heat’ that can be used within various chemical plants to develop other essential goods (e.g. food, and fuel), and also provides the necessary heat needed for natural ecosystems to thrive (e.g. facilitates the growth of cold water fish and algae). This is discussed further in section \ref{sec:necessities_food}. Furthermore, waste heat from the reactor is also capitalised on to address the challenge of bulk cooling on Mars. By using a series of absorption chillers, such as an LiBr absorption chiller that produces water at 2\degree C, and an ammonia absorption chiller that produces a chilled methanol loop at -30\degree C, the waste heat has useful properties that allow for the chilling of objects below the temperature of the lake.
...
We use a regret minimising strategy to estimate the value to the population of a particular phenotype and provide this input to an ensemble classifier to best approximate the global maximum of the fitness problem.
...
The exchange of packages through the inter-planetary postal services is the basis for trade between KCSAR and earth-bound parties. The KCSAR is a member of the United Postal Union (UPU) and therefore part of the standard postal infrastructure between member states. The distribution network relies on ‘multi-modal’ routing, by which packages are carried by the most cost (or time, depending on the cargo) efficient mixture of trucks, trains, boats, and planes. The final step is a cargo rocket that transports bulk post from Earth to Mars. Cargo is transported in standardised containers, allowing for the most space efficient distribution of cargo while maintaining a regulated shape and size to enable easy handling and development of economies of scale in freight handlers.
...
\subsection{Culture}
Given that the residents of KCSAR face extraordinary labor and resource scarcity and live in closely contained quarters, it is critical its emerging culture is one that: (a) cultivates a passion for work that is motivated by a desire to advance the collective interests of the colony, (b) values close communal relationships, (c) fosters and applauds innovative thinking, (d) promotes an appreciation and love for both knowledge acquisition, and knowledge sharing, through a life-long pursuit of education, and (e) celebrates large families.  TODO

\subsection{The future of KCSAR}
To this point, we have laid out the bare bones social and economic processes needed to support a colony of one million people facing pressing existential risk. We have focused on the processes that are distinctively 

detailed how the emerging colony will be set up and develop social structures. 

We turn now, by way of conclusion, to look at what the future will hold. 
Over the coming years, a substantial geoscaping operation will be implemented to make the Crater habitable for humans. A central aluminium space frame-style construction with a series of support pillars will hold up a cover, consisting of a thin PHB layer and a clear layer of lipid-derived wax, acting as a counterweight to the air pressure beneath. This greenhouse structure will be filled with the potent greenhouse gas, SF6, until it reaches the Armstrong limit, increasing the Crater temperature to above 0°C. The Crater’s ice layer will melt, forming a glacial lake. Evaporation of water vapour from the lake can then occur, improving the atmospheric pressure within the Crater. O2 and Ar will then be pumped into the atmosphere to make it habitable for human and other air-breathing life.
