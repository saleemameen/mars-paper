...
Syngas (\ce{H_2}, \cite{CO}) & Syngas is produced via the Zn/S/I cycle (as seen in \ref{sec:necessities_air}) as well as through the gasification of Biomass \\\hline
...
\item Mars is an ideal candidate for large scale nuclear production, so isotropic extraction from spent fuel will be a significant source of revenue. Nuclear isotopes such as \ce{Pu_240}, \ce{Am_241} and \ce{Co_60} are extremely expensive on Earth but would be relatively easy to produce on Mars. Pu240 is used in space probes that are likely to be built nearby in any case.
...
Thanks to the Mars society for hosting the competition. To Giovanni D'urso, for comments and suggestions. 
