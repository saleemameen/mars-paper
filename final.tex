...
%This isn't useful at this stage
%\begin{figure}
%    \centering
%    \includegraphics[width=\linewidth]{figures/fig_mass.png}
%    \caption{Mass of oleic acid}
%    \label{fig:oleic_acid_depth}
%\end{figure}
...
% TODO: Add some sort of very brief introduction regarding what we mean by economic necessities of life and how this differs from the absolute necessities, we just spoke about. 

\subsubsection{Bulk Materials}
\label{sec:necessities_bulk}

% TODO: Ensure that the structure makes sense after @Alex's attempt at a reintegration of a paragraph last night.
...
%This figure is less important and can be cut if we run out of space - it can be replaced with a sentence akin to 'As capital costs decrease, launch price drops linearly'. There's a similar graph for per launch cost going down.
