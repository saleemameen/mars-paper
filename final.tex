...
\Authors{Alex Sharp\textsuperscript{1}*, Saleem Ameen\textsuperscript{2}, Epi Pereria\textsuperscript{3}} % Authors
\affiliation{\textsuperscript{1}\textit{OrionVM}} % Author 1 affiliation
\affiliation{\textsuperscript{2}\textit{??}} % Author 1 affiliation
\affiliation{\textsuperscript{3}\textit{Artist @id\textunderscore epifanio}} % Author 2 affiliation
...
\begin{figure*}
    ...
    \caption{Settlement artificial water cycle. Colors: Blue are inputs, green are outputs.}
