...
%         \centering
%         \includegraphics[width=\textwidth]{fig_demopyr_f.png}
%         \caption{Male demographic pyramid}
%         \label{fig:maleDemograpichPyramid}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}[t]{0.45\textwidth}
%         \centering
%         \includegraphics[width=\textwidth]{fig_demopyr_m.png}
%         \caption{Female demographic pyramid}
%         \label{fig:femaleDemographicPyramid}
%     \end{subfigure}
%     \hfill
%     \caption{Demographic pyramids}
%     \label{fig:populationDemographics}
% \end{figure} 
% %-=-=-=-=-=-=-=-=-=-=-=-=-=-=
...
%%Catalyst citation 10.1016/j.ijhydene.2011.10.054 cited after 'catalyst'
